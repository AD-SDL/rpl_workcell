...
class polybot_Flow(GladierBaseClient):
    ...
    gladier_tools = ["gladier_tools.globus.transfer.Transfer"]


def batman2chemspeed_flow(local_path, fname):
    remote_folder = (
        "/C/Users/Operator/Desktop/Yukun/Workflow/Electrochromic Synthesis/Closeloop/"
    )
    ...
    flow_input = {
        "input": {
            ...
            "transfer_source_path": os.path.join(
                local_path, fname
            ),  # Tecan file location
